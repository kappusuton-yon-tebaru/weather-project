...
type Config struct {
	...
	Geoapify GeopifyAPIConfig `mapstructure:",squash"`
}

type GeopifyAPIConfig struct {
	Endpoint string `mapstructure:"GEOAPIFY_API_ENDPOINT"`
	Key      string `mapstructure:"GEOAPIFY_API_KEY"`
}
